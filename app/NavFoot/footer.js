...
export default function Footer() {
    return (
      <div className="row">
        <footer className="mt-5 mt-lg-0 col-lg-4" >
          <ul className=" p-0 row justify-content-evenly ">
            <li className="col-2 col-lg-3 col-xl-2">
            ...
            <li className="col-2 col-lg-3 col-xl-2">
              <a href="https://www.linkedin.com/in/marcelino-g/" target="_blank">
