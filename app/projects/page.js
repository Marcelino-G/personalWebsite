...
export default function Projects() {
    ...
    return (
        ...
        <div className={`row ${Styles.contentContainer}`}>
            <section className={`col-4 d-flex flex-column justify-content-evenly`}>
            ...
            <section className="col-8 d-flex flex-column" >
                <main className={`mt-4 col-10 ${Styles.projectMainContainer}`}>
                    <AnimatePresence initial={false} mode="wait">
                        <motion.div 
                        key={pages}
                ...
                <div className={`row justify-content-evenly ${Styles.circleArrows}`}>
                    <svg onClick={left} xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-arrow-left-circle-fill col-1" viewBox="0 0 16 16">
                        <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zm3.5 7.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H11.5z"/>
                    </svg>

                    <svg onClick={right} xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-arrow-right-circle-fill col-1" viewBox="0 0 16 16">
