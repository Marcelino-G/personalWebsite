        ...
        <div className={`row ${Styles.contentContainer}`}>
            ...
            <section className={`mt-5                     mt-lg-0 col-lg-4 d-flex flex-lg-column justify-content-around`}>
                ...
                <AnimatePresence initial={false} mode="wait">
                    ...
                    <video autoPlay muted loop controls poster controlslist="nodownload noplaybackrate" className={`col-12 col-lg-12`}>
                ...
                <ul className={` col-5 align-self-center          col-lg-12     ${Styles.projectList}`}>
                    ...
                    {myProjects.map((item) => (
                        <li className="col-lg-8" style={item.num === pages? {opacity: "1", fontSize: "initial"} : {opacity: "0.50", fontSize: "14px"}} onClick={() => {circleAssign(item.num)}}>
                                {item.title}
                        </li>
                    ))}
            ...
            <section className="mt-5 text-center                                  mt-lg-0 text-lg-start col-lg-8 d-flex flex-column" >
                ...
                <div className={`mt-5 mb-5 col-5          mt-md-3           mb-lg-0 col-lg-5 align-self-center d-flex justify-content-between mt-lg-5 ${Styles.circleArrows}`}>
